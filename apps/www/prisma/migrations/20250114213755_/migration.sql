/*
  ...
  - You are about to drop the column `id` on the `QtyControl` table. All the data in the column will be lost.
  ...
  - Added the required column `itemControlUid` to the `QtyControl` table without a default value. This is not possible if the table is not empty.
